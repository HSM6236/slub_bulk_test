...
#
# Output:
#   Results are appended to log files (before-XX.log),
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-16.log
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-32.log
    rmmod slub_bulk_bench
done
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-64.log
    rmmod slub_bulk_bench
done
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-128.log
    rmmod slub_bulk_bench
done
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-256.log
    rmmod slub_bulk_bench
done
...
for i in $(seq 1 20); do
    ...
    dmesg | grep 'slub_bulk_bench:' | tail -n1 >> before-512.log
    rmmod slub_bulk_bench
done